...
import static stoneworld.registry.FluidRegistry.FLUIDS;

public class ModFluidsRender {
    public static void setupFluidRenders() {
        ...
        final Identifier listenerId = new ModIdentifier("waterlike_reload_listener");
